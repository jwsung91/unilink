...
// Convenience macros for automatic tracking
    ...
    #define MEMORY_TRACK_DEALLOCATION(ptr) \
        unilink::common::MemoryTracker::instance().track_deallocation(ptr)
    
    #define MEMORY_TRACK_SCOPE() \
        unilink::common::ScopedMemoryTracker _mem_tracker(__FILE__, __LINE__, __FUNCTION__)
#else
