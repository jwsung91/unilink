...
class BoostSerialPort : public interface::ISerialPort {
 public:
  ...
  void set_option(const net::serial_port_base::baud_rate& option,
                  boost::system::error_code& ec) override {
    port_.set_option(option, ec);
  }
  void set_option(const net::serial_port_base::character_size& option,
                  boost::system::error_code& ec) override {
    port_.set_option(option, ec);
  }
  void set_option(const net::serial_port_base::stop_bits& option,
                  boost::system::error_code& ec) override {
    port_.set_option(option, ec);
  }
  void set_option(const net::serial_port_base::parity& option,
                  boost::system::error_code& ec) override {
    port_.set_option(option, ec);
  }
  void set_option(const net::serial_port_base::flow_control& option,
                  boost::system::error_code& ec) override {
    port_.set_option(option, ec);
  }
