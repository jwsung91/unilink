...
TEST_F(BenchmarkTest, MemoryPoolAllocationPerformance) {
    ...
    auto deallocation_duration = std::chrono::duration_cast<std::chrono::milliseconds>(
        deallocation_time - deallocation_start);
    
    auto total_duration = std::chrono::duration_cast<std::chrono::milliseconds>(
        deallocation_time - start_time);
    ...
    std::cout << "Allocation throughput: " << std::fixed << std::setprecision(2) 
              << allocation_throughput << " ops/sec" << std::endl;
    std::cout << "Deallocation throughput: " << std::fixed << std::setprecision(2) 
              << deallocation_throughput << " ops/sec" << std::endl;
    std::cout << "Total throughput: " << std::fixed << std::setprecision(2) 
              << total_throughput << " ops/sec" << std::endl;
...
TEST_F(BenchmarkTest, MemoryPoolConcurrentPerformance) {
    ...
    for (int t = 0; t < num_threads; ++t) {
        threads.emplace_back([&pool, operations_per_thread, buffer_size, &total_operations, 
...
TEST_F(BenchmarkTest, NetworkCommunicationThroughput) {
    ...
    std::cout << "Duration: " << formatDuration(duration) << std::endl;
    std::cout << "Message throughput: " << std::fixed << std::setprecision(2) 
              << message_throughput << " msg/sec" << std::endl;
    std::cout << "Data throughput: " << std::fixed << std::setprecision(2) 
              << data_throughput << " KB/sec" << std::endl;
