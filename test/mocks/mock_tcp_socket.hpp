...
public:
    ...
    MOCK_METHOD(void, async_connect, 
                (const boost::asio::ip::tcp::endpoint&, ConnectCallback), ());
    
    // Read operations
    MOCK_METHOD(void, async_read_some, 
                (const boost::asio::mutable_buffer&, ReadCallback), ());
    ...
    MOCK_METHOD(void, async_write, 
                (const boost::asio::const_buffer&, WriteCallback), ());
