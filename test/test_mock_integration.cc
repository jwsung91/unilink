...
TEST_F(MockIntegrationTest, SimulatedConnectionFailure) {
    ...
    MockTestScenario::setupConnectionFailure(*mock_socket_, 
                                            MockTestScenario::ConnectionResult::ConnectionRefused);
...
TEST_F(MockIntegrationTest, SimulatedDataTransmission) {
    ...
    MockTestScenario::setupSuccessfulConnection(*mock_socket_);
    MockTestScenario::setupDataTransmission(*mock_socket_, 
                                           MockTestScenario::DataTransferResult::Success);
...
TEST_F(MockIntegrationTest, SimulatedServerClientAcceptance) {
    ...
    EXPECT_CALL(*mock_acceptor_, bind(::testing::_))
        .WillOnce(::testing::Return());
    
    EXPECT_CALL(*mock_acceptor_, listen())
        .WillOnce(::testing::Return());
...
TEST_F(MockIntegrationTest, MockPerformanceTest) {
    ...
    std::cout << "Created " << client_count << " mock clients in " 
