...
TEST(InputValidatorTest, ValidateProtocol) {
  ...
  EXPECT_THROW(InputValidator::validate_ipv6_address("1.1.1.1"), diagnostics::ValidationException); // Not a valid IPv6 format
...
TEST(InputValidatorTest, ValidateSerialParams) {
  ...
  EXPECT_THROW(InputValidator::validate_baud_rate(base::constants::MIN_BAUD_RATE - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_baud_rate(base::constants::MAX_BAUD_RATE + 1), diagnostics::ValidationException);
  ...
  EXPECT_THROW(InputValidator::validate_data_bits(base::constants::MIN_DATA_BITS - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_data_bits(base::constants::MAX_DATA_BITS + 1), diagnostics::ValidationException);
  ...
  EXPECT_THROW(InputValidator::validate_stop_bits(base::constants::MIN_STOP_BITS - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_stop_bits(base::constants::MAX_STOP_BITS + 1), diagnostics::ValidationException);
}
...
TEST(InputValidatorTest, ValidateCommonParams) {
  ...
  EXPECT_THROW(InputValidator::validate_buffer_size(base::constants::MIN_BUFFER_SIZE - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_buffer_size(base::constants::MAX_BUFFER_SIZE + 1), diagnostics::ValidationException);
  ...
  EXPECT_THROW(InputValidator::validate_timeout(base::constants::MIN_CONNECTION_TIMEOUT_MS - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_timeout(base::constants::MAX_CONNECTION_TIMEOUT_MS + 1), diagnostics::ValidationException);
  ...
  EXPECT_THROW(InputValidator::validate_retry_interval(base::constants::MIN_RETRY_INTERVAL_MS - 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_retry_interval(base::constants::MAX_RETRY_INTERVAL_MS + 1), diagnostics::ValidationException);
  ...
  EXPECT_THROW(InputValidator::validate_retry_count(base::constants::MAX_RETRIES_LIMIT + 1), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_retry_count(-2), diagnostics::ValidationException); // Any value less than -1 or less than 0 but not -1
}
...
TEST(InputValidatorTest, ValidateGenericHelpers) {
  ...
  EXPECT_THROW(InputValidator::validate_string_length("too long string", 10, "string_field"), diagnostics::ValidationException);

  // Positive Number
  EXPECT_NO_THROW(InputValidator::validate_positive_number(static_cast<int64_t>(1), "val"));
  EXPECT_THROW(InputValidator::validate_positive_number(static_cast<int64_t>(0), "val"), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_positive_number(static_cast<int64_t>(-1), "val"), diagnostics::ValidationException);

  // Validate Range (int64_t)
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<int64_t>(10), static_cast<int64_t>(0), static_cast<int64_t>(20), "val"));
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<int64_t>(0), static_cast<int64_t>(0), static_cast<int64_t>(20), "val"));
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<int64_t>(20), static_cast<int64_t>(0), static_cast<int64_t>(20), "val"));
  EXPECT_THROW(InputValidator::validate_range(static_cast<int64_t>(-1), static_cast<int64_t>(0), static_cast<int64_t>(20), "val"), diagnostics::ValidationException);
  EXPECT_THROW(InputValidator::validate_range(static_cast<int64_t>(21), static_cast<int64_t>(0), static_cast<int64_t>(20), "val"), diagnostics::ValidationException);

  // Validate Range (size_t)
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<size_t>(10), static_cast<size_t>(0), static_cast<size_t>(20), "val"));
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<size_t>(0), static_cast<size_t>(0), static_cast<size_t>(20), "val"));
  EXPECT_NO_THROW(InputValidator::validate_range(static_cast<size_t>(20), static_cast<size_t>(0), static_cast<size_t>(20), "val"));
  EXPECT_THROW(InputValidator::validate_range(static_cast<size_t>(21), static_cast<size_t>(0), static_cast<size_t>(20), "val"), diagnostics::ValidationException);
