...
TEST_F(UnifiedBuilderIntegrationTest, RealCommunicationBetweenBuilderObjects) {
  ...
  auto client = builder::UnifiedBuilder::tcp_client("127.0.0.1", port_).on_data([](auto&&){}).on_error([](auto&&){}).build();
...
TEST_F(UnifiedBuilderIntegrationTest, BuilderConfigurationAffectsCommunication) {
  ...
  auto client = builder::UnifiedBuilder::tcp_client("127.0.0.1", p).retry_interval(100ms).on_data([](auto&&){}).on_error([](auto&&){}).build();
