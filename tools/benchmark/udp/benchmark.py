...
def main():
    ...
    for load in ping_loads:
        t_py = _median(run_python_udp_pingpong, load)
        t_uni = _median(run_unilink_udp_pingpong, load)
        t_zc = _median(run_unilink_udp_pingpong_zerocopy, load)
    ...
    for load in chunk_loads:
        t_py = _median(run_python_udp_throughput, load)
        t_uni = _median(run_unilink_udp_throughput, load)
