...
BenchResult test_tcp(unilink::base::constants::BackpressureStrategy strategy) {
    ...
    std::thread sender([&] {
        while (running) { if (client.send(payload)) sent_bytes += payload.size(); }
    });
    std::this_thread::sleep_for(seconds(3));
    running = false; sender.join();
...
int main() {
    ...
    std::cout << "| TCP   | " << std::fixed << std::setprecision(2) << std::setw(15) << tcp_r.throughput_mb_s << " | " << std::setw(12) << tcp_r.delivery_rate << "% | " << std::setw(17) << tcp_b.throughput_mb_s << " | " << std::setw(10) << tcp_b.delivery_rate << "% |" << std::endl;
    ...
    std::cout << "| UDS   | " << std::fixed << std::setprecision(2) << std::setw(15) << uds_r.throughput_mb_s << " | " << std::setw(12) << uds_r.delivery_rate << "% | " << std::setw(17) << uds_b.throughput_mb_s << " | " << std::setw(10) << uds_b.delivery_rate << "% |" << std::endl;
    ...
    std::cout << "| UDP   | " << std::fixed << std::setprecision(2) << std::setw(15) << udp_r.throughput_mb_s << " | " << std::setw(12) << udp_r.delivery_rate << "% | " << std::setw(17) << udp_b.throughput_mb_s << " | " << std::setw(10) << udp_b.delivery_rate << "% |" << std::endl;
