...
int main() {
  ...
  std::cout << std::left << std::setw(20) << "Metric" << std::setw(20) << "Reliable" << std::setw(20) << "BestEffort"
            << std::endl;
  std::cout << std::string(60, '-') << std::endl;

  std::cout << std::setw(20) << "Sent (MB)" << std::setw(20) << reliable.sent_mb << std::setw(20) << best_effort.sent_mb
            << std::endl;

  std::cout << std::setw(20) << "Received (MB)" << std::setw(20) << reliable.recv_mb << std::setw(20)
            << best_effort.recv_mb << std::endl;

  std::cout << std::setw(20) << "Throughput (MB/s)" << std::setw(20) << reliable.throughput_mb_s << std::setw(20)
            << best_effort.throughput_mb_s << std::endl;

  std::cout << std::setw(20) << "Delivery Rate (%)" << std::setw(20) << reliable.delivery_rate << std::setw(20)
            << best_effort.delivery_rate << std::endl;
