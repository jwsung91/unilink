...
- Prefer the horizontal logo for README files and documentation headers.
- Use the mark logo for small icons, favicons, and compact views.
- Do not stretch the logo or alter its aspect ratio.
- Use the logo variant that matches the target light or dark background whenever possible.
