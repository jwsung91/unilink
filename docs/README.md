...
- Treat [unilink-lab/unilink-examples](https://github.com/unilink-lab/unilink-examples) as the preferred source for runnable examples.
...
- Keep document roles separated to avoid copy drift:
  ...
  - [unilink-lab/unilink-examples](https://github.com/unilink-lab/unilink-examples): runnable example commands and CLI usage
