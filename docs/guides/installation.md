...
wget https://github.com/jwsung91/unilink/releases/latest/download/unilink-0.1.4-linux-x64.tar.gz
tar -xzf unilink-0.1.4-linux-x64.tar.gz
cd unilink-0.1.4-linux-x64
```
...
- **Conan recipe**: `packaging/conan`
  - Build/test locally (Conan v2): `conan create packaging/conan --name=unilink --version=0.1.4`
